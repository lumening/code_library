...
/*
       # a  picture class,
       # download by  http://www.cnblogs.com/zhangqifeng/archive/2009/06/17/1505020.html
...
$t = new ThumbHandler();
//给图片增加水印
$t->setSrcImg("./upload/20130407092703.jpg");
$t->setDstImg("./upload/new_test.jpg");
$t->setMaskImg("./upload/xinhuawang.gif");
$t->setMaskPosition(4);
$t->setMaskImgPct(80);
...
$t->createImg(400,420);
?>
<img src="./upload/20130407092703.jpg">
<img src="./upload/new_test.jpg">
